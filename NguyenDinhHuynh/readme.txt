...
Chú ý :
 - Chạy project trên máy với địa chỉ : http://localhost/ (với cổng mặc định là 80).
 - Chạy phpmyadmin trên máy với địa chỉ : http://localhost/phpmyadmin/
   usename and password : root